if (enemyHealth > 0) {
	switch (gunState) {
		...
		case 1:
			...
			if ( newTargetAngle > 88 && newTargetAngle < 180) {
				newTargetAngle = 88;
			}
			
			if ( newTargetAngle >= 180 && newTargetAngle < 268) {
				newTargetAngle = 268;
			}
			...
			gunOffsetX = lengthdir_x(25,newTargetAngle);
			gunOffsetY = lengthdir_y(25,newTargetAngle);
